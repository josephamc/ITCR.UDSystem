...
namespace ITCR.UDSystem.Base
{
	...
	public class cUDGDFCURSOBase : cBDInteraccionBase
	{
		#region Declaraciones de miembros de la clase
			private SqlBoolean		_cOD_MARTES, _cOD_JUEVES, _cOD_VIERNES, _cOD_MIERCOLES, _cOD_LUNES;
			private SqlInt32		_fKY_CALENDARIO, _fKY_CALENDARIOOld, _fKY_RESERVACION, _fKY_RESERVACIONOld, _iD_CURSO;
