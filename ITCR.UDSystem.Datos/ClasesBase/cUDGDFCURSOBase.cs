...
namespace ITCR.UDSystem.Base
{
    ...
    public class cUDGDFCURSOBase : cBDInteraccionBase
    {
        ...
        private SqlString _nOM_PROFESOR, _nOM_CURSO;
        #endregion
        ...
        public override bool Insertar()
        {
            ...
            try
            {
                ...
                cmdAEjecutar.Parameters.Add(new SqlParameter("@sNOM_CURSO", SqlDbType.VarChar, 100, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, _nOM_CURSO));
        ...
        public override DataTable SeleccionarUno()
        {
            ...
            try
            {
                ...
                if (toReturn.Rows.Count > 0)
                {
                    ...
                    _nOM_CURSO = toReturn.Rows[0]["NOM_CURSO"] == System.DBNull.Value ? SqlString.Null : (string)toReturn.Rows[0]["NOM_CURSO"];
                }
                return toReturn;
            }
            catch (Exception ex)
