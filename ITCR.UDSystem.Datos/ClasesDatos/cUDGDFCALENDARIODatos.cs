...
{
	/// <summary>
	/// Propósito: Clase de acceso a datos derivada para tabla 'UDGDFCALENDARIO'.
	/// </summary>
	public class cUDGDFCALENDARIODatos : cUDGDFCALENDARIOBase
	{
		...
		/// </summary>
		public cUDGDFCALENDARIODatos() : base()
		{
			// Agregar código aquí.
		}
