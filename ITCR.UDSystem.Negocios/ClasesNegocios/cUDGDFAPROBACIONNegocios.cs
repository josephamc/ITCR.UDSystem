...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'UDGDFAPROBACION'.
	/// </summary>
	public class cUDGDFAPROBACIONNegocios : cUDGDFAPROBACIONDatos
	{
		...
		/// </summary>
		public cUDGDFAPROBACIONNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cUDGDFAPROBACION;"
					+"FKY_SOLICITUD:"+FKY_SOLICITUD.ToString()+";"
					+"FKY_RESEREVACION:"+FKY_RESEREVACION.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cUDGDFAPROBACION;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cUDGDFAPROBACION;"
					+"ID_APROBACION:"+ID_APROBACION.ToString()+";"
					+"FKY_SOLICITUD:"+FKY_SOLICITUD.ToString()+";"
					+"FKY_RESEREVACION:"+FKY_RESEREVACION.ToString()+";";
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cUDGDFAPROBACION;"+ex.Message;
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cUDGDFAPROBACION;"
					+"ID_APROBACION:"+ID_APROBACION.ToString()+";";
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cUDGDFAPROBACION;"+ex.Message;
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
