...
// Proyecto: UDsystem
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'UDGDFRESPUESTA'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'UDGDFRESPUESTA'.
	/// </summary>
	public class cUDGDFRESPUESTANegocios : cUDGDFRESPUESTADatos
	{
		...
		/// </summary>
		public cUDGDFRESPUESTANegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cUDGDFRESPUESTA;"
					+"TXT_OBSERVACION:"+TXT_OBSERVACION.ToString()+";"
					+"FKY_NOTIFICACION:"+FKY_NOTIFICACION.ToString()+";"
					+"FKY_SOLICITUD:"+FKY_SOLICITUD.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cUDGDFRESPUESTA;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cUDGDFRESPUESTA;"
					+"ID_RESPUESTA:"+ID_RESPUESTA.ToString()+";"
					+"TXT_OBSERVACION:"+TXT_OBSERVACION.ToString()+";"
					+"FKY_NOTIFICACION:"+FKY_NOTIFICACION.ToString()+";"
					+"FKY_SOLICITUD:"+FKY_SOLICITUD.ToString()+";";
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cUDGDFRESPUESTA;"+ex.Message;
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cUDGDFRESPUESTA;"
					+"ID_RESPUESTA:"+ID_RESPUESTA.ToString()+";";
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cUDGDFRESPUESTA;"+ex.Message;
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
