...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'UDGDFUSUARIO'.
	/// </summary>
	public class cUDGDFUSUARIONegocios : cUDGDFUSUARIODatos
	{
		...
		/// </summary>
		public cUDGDFUSUARIONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cUDGDFUSUARIO;"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cUDGDFUSUARIO;"+ex.Message;
