...
// Proyecto: UDsystem
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'UDGDFNTIFICACION'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'UDGDFNTIFICACION'.
	/// </summary>
	public class cUDGDFNTIFICACIONNegocios : cUDGDFNTIFICACIONDatos
	{
		...
		/// </summary>
		public cUDGDFNTIFICACIONNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cUDGDFNTIFICACION;"
					+"TXT_PREDETERMINADO:"+TXT_PREDETERMINADO.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cUDGDFNTIFICACION;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cUDGDFNTIFICACION;"
					+"ID_NOTIFICACION:"+ID_NOTIFICACION.ToString()+";"
					+"TXT_PREDETERMINADO:"+TXT_PREDETERMINADO.ToString()+";";
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cUDGDFNTIFICACION;"+ex.Message;
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cUDGDFNTIFICACION;"
					+"ID_NOTIFICACION:"+ID_NOTIFICACION.ToString()+";";
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cUDGDFNTIFICACION;"+ex.Message;
				wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
