...
namespace ITCR.UDSystem.Negocios
{
    ...
    public class cUDGDFSOLICITUDNegocios : cUDGDFSOLICITUDDatos
    {
        ...
        /// </summary>
        public cUDGDFSOLICITUDNegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora)
            : base()
        {
        ...
        /// <returns>DataTable Object</returns>
        public override DataTable SeleccionarAprobadas(DateTime p_fechainicio, DateTime p_fechafin)
        {
            try
            {
                return base.SeleccionarAprobadas(p_fechainicio, p_fechafin);
            }
            catch (Exception ex)
            {
                throw ex;
