<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmCurso.aspx.cs" Inherits="ITCR.UDSystem.Interfaz.CU_AdministrarCalendario.frmCurso" %>
        ...
        <!-- Main Container -->
            ...
            <fieldset>
                ...
                <div>
                    ...
                    <br />
                   Formato de la fecha dd/MM/yy. Ejem: 31/12/2012
                    <br />
                    <br />
                    Hora inicio:
                    ...
                    <asp:Label ID="lbl_ErrorCalendario" runat="server" ForeColor="Red" 
                        Text="El calendario que esta tratando de guardar choca con alguna actividad ya existente." 
                        Visible="False"></asp:Label>
                    <br />
                    <br />
                    Días:
